...
def train_model(model, epochs, criterion, optimizer, dataloaders, dataset_sizes, device, ):
    ...
    while learning:
        for phase in ['train', 'val']:
            ...
            for b, (images, labels) in enumerate(dataloaders[phase]):
                ...
                with torch.set_grad_enabled(phase == 'train'):
                    ...
                    loss = criterion(outputs, labels.flatten()) # replace the placeholders with suitable values to compute the loss function
